...
public class AltaEmpleado extends javax.swing.JFrame {
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        // TODO add your handling code here:
        int respuesta = JOptionPane.showConfirmDialog(this, "Esta acción borrará los datos acruales. ¿Estás seguro de continuar?");
        if (respuesta == 0) {//constantes de clase
            //leer datos del archivo
            //subir al array list
            //El primer elemento se pondrá en el formulario
            ArchivoEmpleado persistencia = new ArchivoEmpleado();
            JFileChooser jfc = new JFileChooser();
    ...
    private void llenarFormulario(int indice) {
        if (lista.size() > 0) {
            ...
            //this.jTextField11.setText(e.getDomicilio().get);
